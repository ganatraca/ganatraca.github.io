...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      const textSets = [
      // {
      //    h1: "Assurance That<br>Strengthens Trust",
      //    p: "We deliver rigorous audit and assurance services grounded in professional standards, giving stakeholders confidence in every financial statement."
      // },
      {
         h1: "Advanced Tax Strategy<br>Optimized",
         p: "Our specialists apply deep technical expertise in direct and indirect taxation to minimize liabilities, ensure compliance, and enhance fiscal efficiency."
      },
      {
         h1: "Precision in<br>Financial Governance",
         p: "From IFRS-aligned reporting to internal control systems, we engineer robust financial frameworks that elevate accuracy, accountability, and performance."
      },
      {
      h1: "Advisory Backed by<br>Analytical Rigor",
      p: "We combine forensic analysis, valuation expertise, and data-driven insights to guide strategic decisions and safeguard financial integrity."
      }
...
function animateCounter(element) {
   ...
   const timer = setInterval(() => {
      ...
      element.textContent = value + '+'; //target > 100 ? value : value + '+';

      if (current >= target) {
         element.textContent = target  + '+'; //target > 100 ? target : target  + '+';
         clearInterval(timer);
      }
   }, 25);
}
